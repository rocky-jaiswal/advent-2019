...
private fun calc(input: List<Int>) {
    ...
    while(true) {
        ...
        if (code > 10) {
            ...
            val op1 = if(paramModes[2] == 0) mutableInput[mutableInput[i+1]] else mutableInput[i+1]
            val op2 = if(paramModes[1] == 0) mutableInput[mutableInput[i+2]] else mutableInput[i+2]
            if(opcode == 1) {
